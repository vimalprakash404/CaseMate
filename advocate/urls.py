...
from .views import advocate_addcasesections,adv_case_details, adv_login, adv_home,adv_case,contact,todolist,dashbord,ad_upadte_hearing_details,ad_close_case,adv_closed_case,adv_judgement_case
urlpatterns = [
    path("",adv_login),
    ...
    path("case/addsections/<int:id>",advocate_addcasesections,name="advocate_addcasesections"),
